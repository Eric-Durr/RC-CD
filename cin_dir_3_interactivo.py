...
T46 = matriz_T(d [6],th [6],a [6],al [6])
T06 =np.dot(T04, T46 )
...
ef = o60
OR = ramal([o00 ,o10 ,o20 ,o2P0 ,o30 ,o40 ,[[o510],[o520]]])
OT = np.array(OR).T
fig = plt.figure()
ax = fig.add_subplot(111, projection='3d')
...
def update(val): 
  ...
  # Parámetros D-H:
  #         1     2    2'    3           4        5.1    6         5.2
  d  = [ vxs,    0,   0, hxs,          0,         0,   0,          0]
  th = [    0, els, -90,   90, (wrs-180),  (90-cls), 90,  (90+cls)]
  a  = [    0,    5,   0,    0,          0,         2,   2,          2]
  al = [    0,    0, -90,    0,         90,         0,   0,          0]
...
h_extensor_slider.on_changed(update)
